...
public class LibraryBookTest {
    ...
    static Book test_book3 = new Book("Anthony", "Lepoop", "How to ride a bike", 2023, 666);
    static Book test_book4 = new Book("Martin", "Robart", "Anime is not art!", 2022, 1337);
    static Book test_book5 = new Book("Rozetka", "Petrovich", "ElectroCUTE <3", 1990, 444);
